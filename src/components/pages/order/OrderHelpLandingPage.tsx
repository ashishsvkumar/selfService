...
const helpLinks = (tradeOrderId: string): HelpLink[] => [
    ...
    { text: "I have missing items", url: `/orders/${tradeOrderId}/help/missing`, enableOn: ["All", "Delivered"] },
    { text: "I have problem with the received items", url: `/orders/${tradeOrderId}/help/damaged`, enableOn: ["All", "Delivered"] },
