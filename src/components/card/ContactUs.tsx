...
export const PopupText = () => {
    return (
        <div style={{ border: '1px solid #ddd', padding: '12px 14px', fontSize: '14px' }}>
            ...
            <a href={`tel:${Constants.CS_PHONE_PLAIN}`} style={{ fontSize: '14px', color: '#333', fontWeight: 'bold', display: 'inline-block', marginRight: '12px' }}>{Constants.CS_PHONE_PLAIN_FORMATTED}</a>
